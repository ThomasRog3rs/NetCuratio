...
namespace NetCuratio_CommonLayer.Objects
{
    public class CaseStudyModel
    {
        ...
        static string KrObjective = "KR Wellness is a leading health and fitness specialist in the Manchester area. After establishing his brand on social media, it was clear that he required a strong and professional online presence to take his business to the next level. Our goal was to create a unique and professional digital brand that distinguished KR Wellness in the highly competitive fitness market. ";
        static string NaxiasObjective = "Naxian Castle is a beautiful holiday destination in the Greek Islands. The owner of the location has advertised with many popular booking companies for a long time but has been unable to leverage the full potential of the property. The goal of the website was to create a booking platform to effectively upsell holiday packages which included tours, activities, and meals out on the island.";
        static string TalkHealObjective = "Talk N' Heal is a psychotherapy business that offers many different forms of therapy sessions. Our goal with the website was to create a strong and authoritative online presence for Talk N' Heal, to mark it out on the map as the legitimate enterprise that it is. We also wanted to create a managed booking solution for them, whereby customers could select the time and date of their session, thus eliminating a great deal of administrative overhead.";
        ...
        public static List<CaseStudy> CaseStudies = new List<CaseStudy>() {
            ...
            new CaseStudy
            {
                ...
                Intro = string.Format("{0}...", TruncateAtWord(NaxiasObjective, truncateAt)),
                Objective = NaxiasObjective,
                ...
                HomeText = "As you can see below, the theme that we designed for the website has emphasised the natural beauty of Naxian Castle. The booking bundles are promoted and the booking availability widget is accessible right at the start of the landing page. Nexian castle has seen a growth in bookings and profits from our work. Mission successful. "
            ...
            new CaseStudy
            {
                ...
                Intro = string.Format("{0}...", TruncateAtWord(TalkHealObjective, truncateAt)),
                Objective = TalkHealObjective,
